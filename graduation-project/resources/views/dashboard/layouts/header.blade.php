...
<nav class="admin-header navbar navbar-default col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
    ...
    <div class="text-left navbar-brand-wrapper">
        <a class="navbar-brand brand-logo" href="{{ route('dashboard.home') }}"><img src="{{ asset('dashboard/assets/images/logo.png') }}" alt="" ></a>
        <a class="navbar-brand brand-logo-mini" href="{{ route('dashboard.home') }}"><img src="{{ asset('dashboard/assets/images/logo.png') }}.png"
                                                                       alt=""></a>
    </div>
    <!-- Top bar left -->
